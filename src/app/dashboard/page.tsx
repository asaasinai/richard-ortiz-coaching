  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        <h1 style={{ fontFamily:"Inter Tight,sans-serif",fontWeight:900,fontSize:"2.5rem",letterSpacing:"-0.03em" }}>Client Dashboard</h1>
        <div style={{ background:"rgba(201,168,76,0.08)",border:"1px solid var(--gold)",borderRadius:"var(--radius)",padding:"1rem 1.25rem",marginTop:"1.5rem",display:"flex",gap:"0.75rem",alignItems:"center" }}>
          ...
          <span style={{ color:"var(--text-soft)",fontSize:"0.9rem" }}>Authentication coming soon. Your coach will send you a login link after intake approval.</span>
        </div>
