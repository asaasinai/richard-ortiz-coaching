...
const peptides = [
  ...
  { name: "PT-141 (Bremelanotide)", slug: "pt-141", summary: "Central nervous system-acting libido enhancer — FDA-approved for female sexual dysfunction.", category: "Libido" },
  ...
  { name: "TB-500 (Thymosin Beta-4)", slug: "tb-500", summary: "Actin-binding peptide — muscle repair, flexibility, cardiovascular recovery, hair regrowth.", category: "Healing & Recovery" },
          ...
          <div key={cat} className="mt-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {peptides.filter(p => p.category === cat).map(p => (
                <div key={p.slug} className="card flex flex-col gap-3 hover:border-gold transition-colors" style={{ borderColor: "var(--border)" }}>
