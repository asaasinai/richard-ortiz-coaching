...
export default function QuickProposalPage() {
  ...
  // ── Success: show the textable link ──
  if (link) return (
    <div style={{ maxWidth: 560, margin: "0 auto" }}>
      <PageHeader title="Proposal link ready" subtitle="Text this to the client. They review, sign, and you're notified by email." backHref="/admin" />
  ...
  return (
    <div style={{ maxWidth: 560, margin: "0 auto" }}>
      <PageHeader title="New Proposal" subtitle="Build a protocol and generate a link to text the client." backHref="/admin" />
