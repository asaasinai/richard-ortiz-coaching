...
export default async function AdminOverview() {
  ...
  return (
    <div>
      <h1 style={{ fontFamily:"Inter Tight,sans-serif",fontWeight:900,fontSize:"1.75rem",letterSpacing:"-0.02em",marginBottom:"0.25rem" }}>Overview</h1>
      <p style={{ color:"var(--text-mute)",fontSize:"0.875rem",marginBottom:"2rem" }}>Richard Ortiz Coaching — Admin Dashboard</p>

      {/* Stat cards */}
      <div style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"1rem",marginBottom:"2.5rem" }}>
        {cards.map(c => (
          <div key={c.label} className="card">
            <c.icon size={18} style={{ color:c.color,marginBottom:"0.75rem" }} />
      ...
      {/* Recent intakes */}
      <div className="card">
        <h2 style={{ fontWeight:700,fontSize:"1rem",marginBottom:"1.25rem" }}>Recent Intakes</h2>
