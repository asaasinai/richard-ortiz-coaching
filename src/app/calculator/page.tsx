  ...
  const stepReview = peptide && conc !== null && volMl !== null ? (
    <div className="flex flex-col gap-5">
      ...
      <div id="dosing-card" style={{ background:"var(--surface-2)", border:"1px solid var(--border)", borderRadius:"var(--radius)", padding:"1.25rem" }}>
        ...
        <div style={{ fontSize:"0.75rem", color:"var(--text-mute)", marginBottom:"1rem" }}>Generated by Richard Ortiz Coaching · Educational use only</div>
        {[
      ...
      <label style={{ display:"flex", gap:"0.75rem", alignItems:"flex-start", cursor:"pointer" }}>
        ...
        <span style={{ fontSize:"0.875rem", color:"var(--text-soft)", lineHeight:1.6 }}>
          I confirm I have reviewed the contraindications, understand this is for educational purposes only, and will consult a licensed physician before starting any protocol.
        </span>
      </label>
